...
#    '/home/www/koha_far/etc/koha-conf.xml', as happens
...
my $INSTALLED_CONFIG_FNAME = '/home/www/koha_far/etc/koha-conf.xml';
                # path to config file set by installer
                # /home/www/koha_far/etc is set by rewrite-confg.PL
                # when Koha is installed in 'standard' or 'single'
                # mode.  If Koha was installed in 'dev' mode, 
                # /home/www/koha_far/etc is *not* rewritten; instead
