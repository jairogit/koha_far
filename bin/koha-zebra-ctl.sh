...
LOGDIR=/home/www/koha_far/var/log
ERRLOG=$LOGDIR/koha-zebradaemon.err
STDOUT=$LOGDIR/koha-zebradaemon.log
OUTPUT=$LOGDIR/koha-zebradaemon-output.log
KOHA_CONF=/home/www/koha_far/etc/koha-conf.xml
RUNDIR=/home/www/koha_far/var/run/zebradb
LOCKDIR=/home/www/koha_far/var/lock/zebradb
